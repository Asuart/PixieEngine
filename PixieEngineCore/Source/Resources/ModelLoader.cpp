...
std::vector<Texture> ModelLoader::ProcessAssimpMaterialTextures(const std::filesystem::path& filePath, const aiMaterial* material, aiTextureType type, const std::string& name) {
