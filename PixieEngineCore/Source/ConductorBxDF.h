...
public:
	...
	BSDFSample SampleDirectionAndDistribution(Vec3 wo, Float uc, Vec2 u, TransportMode mode = TransportMode::Radiance, BxDFReflTransFlags sampleFlags = BxDFReflTransFlags::All) const override;
