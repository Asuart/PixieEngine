...
struct Material {
	...
	Material(const std::string& name, Spectrum albedo = Spectrum(0.8f), Spectrum emission = Spectrum(0.0f), float roughness = 1.0f, float metallic = 0.0f, float transparency = 0.0f, float refraction = 1.0f);
